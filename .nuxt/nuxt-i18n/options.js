...
export const locales = [{"code":"en","file":"en-US.js"},{"code":"es","file":"es-ES.js"},{"code":"id","file":"id-ID.js"}]
...
export const detectBrowserLanguage = {"useCookie":true,"cookieCrossOrigin":true,"cookieDomain":null,"cookieKey":"i18n_redirected","cookieSecure":false,"alwaysRedirect":true,"fallbackLocale":"","onlyOnNoPrefix":false,"onlyOnRoot":false}
...
export const localeCodes = ["en","es","id"]
